...
- Use `$ARGUMENTS` as scope (e.g., "components", "api module")
- Continue to step 3

If no arguments:

- Ask: "What code do you want to refactor?"
- Show examples: "components", "api module", "useWorkflow.ts", "all hooks"
...
- Poor type safety (any, unknown without narrowing, etc.)
