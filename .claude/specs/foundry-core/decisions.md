...
## D23: AI Cost Management

**Date:** 2025-11-26
**Status:** Decided

**Context:**
Need to track and control AI costs, especially for expensive operations like reverse engineering with Opus.

**Decision:** Multi-tier budget system with warnings and hard limits
...
**Rationale:**
- Prevents surprise bills from expensive Opus operations
- Gradual warnings (80%, 95%, 100%) allow user control
- Per-operation limits catch runaway workflows
- Monthly reset aligns with typical billing cycles
- Transparent cost estimation builds trust
- Granular tracking enables optimization
